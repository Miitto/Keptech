...
#pragma clang diagnostic ignored "-Wunused-parameter"
    ...
    [[nodiscard]] virtual bool getClearDepthStencil(DepthClearValue* value) const { return true; }
    [[nodiscard]] virtual bool getClearColor(size_t attachmentIndex, ColorClearValue* value) const { return true; }
    ...
    virtual void setup(RenderGraph& graph, Renderer& renderer
#ifdef KT_VULKAN
                       ,
    ...
    virtual void execute(RenderGraph& graph, const CommandBuffer& cmd,
#ifdef KT_VULKAN
