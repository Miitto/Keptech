...
#define LOG(...) KT_TRACE(__VA_ARGS__) // NOLINT
  ...
  RenderTextureResource& RenderPassBuilder::addHistoryInput(const std::string& n) {
    ...
    res
#ifdef KT_VULKAN
        .addImageUsage(KT_IMAGE_USAGE_SAMPLED)
#endif
        .addQueue(queue);
  ...
  RenderBufferResource& RenderPassBuilder::addGenericBufferInput(const std::string& n
#ifdef KT_VULKAN
                                                                 ,
  ...
  RenderBufferResource& RenderPassBuilder::addVertexBufferInput(const std::string& n) {
    ...
    return addGenericBufferInput(n
#ifdef KT_VULKAN
                                 ,
                                 VK_PIPELINE_STAGE_VERTEX_INPUT_BIT, VK_ACCESS_VERTEX_ATTRIBUTE_READ_BIT, VK_BUFFER_USAGE_VERTEX_BUFFER_BIT
#endif
    );
  }
...
#ifdef KT_VULKAN
                                 ,
                                 VK_PIPELINE_STAGE_VERTEX_INPUT_BIT, VK_ACCESS_INDEX_READ_BIT, VK_BUFFER_USAGE_INDEX_BUFFER_BIT
#endif
    );
  }
  ...
  void RenderPassBuilder::setupDependencies(const Renderer& renderer) {
    if (passInterface)
      passInterface->setupDependencies(*this, graph, renderer);
  }
...
#ifdef KT_VULKAN
        .addBufferUsage(VK_BUFFER_USAGE_STORAGE_BUFFER_BIT)
#endif
        .addQueue(queue)
        .writtenInPass(id);
  ...
  RenderTextureResource& RenderPassBuilder::addTextureInput(const std::string& n
    ...
    res
#ifdef KT_VULKAN
        .addImageUsage(VK_IMAGE_USAGE_SAMPLED_BIT)
#endif
        .addQueue(queue)
        .readInPass(id);
...
#ifdef KT_VULKAN
        .addImageUsage(VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT)
#endif
        .addQueue(queue)
        .writtenInPass(id);
  ...
  RenderTextureResource& RenderPassBuilder::addStorageImageOutput(const std::string& n, const AttachmentInfo& info,
    ...
    res.setAttachmentInfo(info)
#ifdef KT_VULKAN
        .addImageUsage(VK_IMAGE_USAGE_STORAGE_BIT)
#endif
        .addQueue(queue)
        .writtenInPass(id);
  ...
  RenderTextureResource& RenderPassBuilder::setDepthStencilInput(const std::string& n) {
    ...
    res
#ifdef KT_VULKAN
        .addImageUsage(VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT | VK_IMAGE_USAGE_SAMPLED_BIT)
#endif
        .addQueue(queue)
        .readInPass(id);
  ...
  RenderTextureResource& RenderPassBuilder::setDepthStencilOutput(const std::string& n, const AttachmentInfo& info) {
    ...
    res.setAttachmentInfo(info)
#ifdef KT_VULKAN
        .addImageUsage(VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT)
#endif
        .addQueue(queue)
        .writtenInPass(id);
