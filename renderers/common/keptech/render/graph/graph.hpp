...
#include "keptech/render/graphInterface.hpp"
...
namespace kt::rdr {
  ...
  public:
    ...
    void setGetClearDepthStencilCallback(std::function<bool(DepthClearValue*)>&& cb);
    void setGetClearColorCallback(std::function<bool(uint32_t, ColorClearValue*)>&& cb);
