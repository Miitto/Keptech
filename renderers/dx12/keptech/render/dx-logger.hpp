...
#define DX_TRACE(...) kt::rdr::logger->log(spdlog::source_loc{__FILE__, __LINE__, SPDLOG_FUNCTION}, spdlog::level::trace, __VA_ARGS__)
#else
#define DX_TRACE(...) (void)0
#endif

#if RENDERER_LOG_LEVEL <= SPDLOG_LEVEL_DEBUG
#define DX_DEBUG(...) kt::rdr::logger->log(spdlog::source_loc{__FILE__, __LINE__, SPDLOG_FUNCTION}, spdlog::level::debug, __VA_ARGS__)
#else
#define DX_DEBUG(...) (void)0
#endif

#if RENDERER_LOG_LEVEL <= SPDLOG_LEVEL_INFO
#define DX_INFO(...) kt::rdr::logger->log(spdlog::source_loc{__FILE__, __LINE__, SPDLOG_FUNCTION}, spdlog::level::info, __VA_ARGS__)
#else
#define DX_INFO(...) (void)0
#endif

#if RENDERER_LOG_LEVEL <= SPDLOG_LEVEL_WARN
#define DX_WARN(...) kt::rdr::logger->log(spdlog::source_loc{__FILE__, __LINE__, SPDLOG_FUNCTION}, spdlog::level::warn, __VA_ARGS__)
#else
#define DX_WARN(...) (void)0
#endif

#if RENDERER_LOG_LEVEL <= SPDLOG_LEVEL_ERROR
#define DX_ERROR(...) kt::rdr::logger->log(spdlog::source_loc{__FILE__, __LINE__, SPDLOG_FUNCTION}, spdlog::level::err, __VA_ARGS__)
#else
#define DX_ERROR(...) (void)0
#endif

#if RENDERER_LOG_LEVEL <= SPDLOG_LEVEL_CRITICAL
#define DX_CRITICAL(...) kt::rdr::logger->log(spdlog::source_loc{__FILE__, __LINE__, SPDLOG_FUNCTION}, spdlog::level::critical, __VA_ARGS__)
#else
