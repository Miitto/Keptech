...
namespace kt::vkh {
  ...
  void Renderer::deferredToRenderable(VkCommandBuffer cmdBuf) {
    std::array transitions{
        VkImageMemoryBarrier2{
            ...
            .image = *m.renderTargets.gBuffer.albedo,
            .subresourceRange =
        ...
        VkImageMemoryBarrier2{
            ...
            .srcQueueFamilyIndex = VK_QUEUE_FAMILY_IGNORED,
            .dstQueueFamilyIndex = VK_QUEUE_FAMILY_IGNORED,
            .image = *m.renderTargets.gBuffer.normal,
            .subresourceRange =
                VkImageSubresourceRange{
                    .aspectMask = VK_IMAGE_ASPECT_COLOR_BIT,
                    .baseMipLevel = 0,
        ...
        VkImageMemoryBarrier2{
            ...
            .srcQueueFamilyIndex = VK_QUEUE_FAMILY_IGNORED,
            .dstQueueFamilyIndex = VK_QUEUE_FAMILY_IGNORED,
            .image = *m.renderTargets.gBuffer.emissive,
            .subresourceRange =
                VkImageSubresourceRange{
                    .aspectMask = VK_IMAGE_ASPECT_COLOR_BIT,
                    .baseMipLevel = 0,
        ...
        VkImageMemoryBarrier2{
            ...
            .srcQueueFamilyIndex = VK_QUEUE_FAMILY_IGNORED,
            .dstQueueFamilyIndex = VK_QUEUE_FAMILY_IGNORED,
            .image = *m.renderTargets.gBuffer.metRough,
            .subresourceRange =
                VkImageSubresourceRange{
                    .aspectMask = VK_IMAGE_ASPECT_COLOR_BIT,
                    .baseMipLevel = 0,
        ...
        VkImageMemoryBarrier2{
            ...
            .srcQueueFamilyIndex = VK_QUEUE_FAMILY_IGNORED,
            .dstQueueFamilyIndex = VK_QUEUE_FAMILY_IGNORED,
            .image = *m.renderTargets.gBuffer.depth,
            .subresourceRange =
                VkImageSubresourceRange{
  ...
  void Renderer::deferredBeginRendering(VkCommandBuffer cmdBuf) {
    std::array colorAttachments = {
        VkRenderingAttachmentInfo{
            ...
            .imageView = *m.renderTargets.gBuffer.albedo,
        ...
        VkRenderingAttachmentInfo{
            .sType = VK_STRUCTURE_TYPE_RENDERING_ATTACHMENT_INFO,
            .imageView = *m.renderTargets.gBuffer.normal,
            .imageLayout = VkImageLayout::VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL,
            .loadOp = VK_ATTACHMENT_LOAD_OP_CLEAR,
            .storeOp = VK_ATTACHMENT_STORE_OP_STORE,
            .clearValue =
        ...
        VkRenderingAttachmentInfo{
            .sType = VK_STRUCTURE_TYPE_RENDERING_ATTACHMENT_INFO,
            .imageView = *m.renderTargets.gBuffer.emissive,
            .imageLayout = VkImageLayout::VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL,
            .loadOp = VK_ATTACHMENT_LOAD_OP_CLEAR,
            .storeOp = VK_ATTACHMENT_STORE_OP_STORE,
            .clearValue =
        ...
        VkRenderingAttachmentInfo{
            .sType = VK_STRUCTURE_TYPE_RENDERING_ATTACHMENT_INFO,
            .imageView = *m.renderTargets.gBuffer.metRough,
            .imageLayout = VkImageLayout::VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL,
            .loadOp = VK_ATTACHMENT_LOAD_OP_CLEAR,
            .storeOp = VK_ATTACHMENT_STORE_OP_STORE,
            .clearValue =
    ...
    VkRenderingAttachmentInfo depthAttachment{
        .sType = VK_STRUCTURE_TYPE_RENDERING_ATTACHMENT_INFO,
        .imageView = *m.renderTargets.gBuffer.depth,
  ...
  void Renderer::shadowMapToRenderable(VkCommandBuffer cmdBuf, const Image& shadowMap, bool isCube) {
  ...
  void Renderer::shadowMapBeginRendering(VkCommandBuffer cmdBuf, const Image& shadowMap, bool isCube) {
    VkRenderingAttachmentInfo depthAttachment{
        .sType = VK_STRUCTURE_TYPE_RENDERING_ATTACHMENT_INFO,
        .imageView = shadowMap,
  ...
  void Renderer::shadowMapToShaderRead(VkCommandBuffer cmdBuf, const Image& shadowMap, bool isCube) {
    VkImageMemoryBarrier2 transition{
        .sType = VK_STRUCTURE_TYPE_IMAGE_MEMORY_BARRIER_2,
  ...
  void Renderer::lightsToRenderable(VkCommandBuffer cmdBuf) {
    std::array transitions{
        VkImageMemoryBarrier2{
            ...
            .srcQueueFamilyIndex = VK_QUEUE_FAMILY_IGNORED,
            .dstQueueFamilyIndex = VK_QUEUE_FAMILY_IGNORED,
            .image = *m.renderTargets.lights.diffuse,
            .subresourceRange =
                VkImageSubresourceRange{
                    .aspectMask = VK_IMAGE_ASPECT_COLOR_BIT,
                    .baseMipLevel = 0,
        ...
        VkImageMemoryBarrier2{
            ...
            .srcQueueFamilyIndex = VK_QUEUE_FAMILY_IGNORED,
            .dstQueueFamilyIndex = VK_QUEUE_FAMILY_IGNORED,
            .image = *m.renderTargets.lights.specular,
            .subresourceRange =
                VkImageSubresourceRange{
                    .aspectMask = VK_IMAGE_ASPECT_COLOR_BIT,
                    .baseMipLevel = 0,
        ...
        VkImageMemoryBarrier2{
            ...
            .srcQueueFamilyIndex = VK_QUEUE_FAMILY_IGNORED,
            .dstQueueFamilyIndex = VK_QUEUE_FAMILY_IGNORED,
            .image = *m.renderTargets.lights.combined,
            .subresourceRange =
                VkImageSubresourceRange{
                    .aspectMask = VK_IMAGE_ASPECT_COLOR_BIT,
                    .baseMipLevel = 0,
  ...
  void Renderer::seperatedLightsBeginRendering(VkCommandBuffer cmdBuf) {
    std::array colorAttachments = {
        VkRenderingAttachmentInfo{
            .sType = VK_STRUCTURE_TYPE_RENDERING_ATTACHMENT_INFO,
            .imageView = *m.renderTargets.lights.diffuse,
            .imageLayout = VkImageLayout::VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL,
            .loadOp = VK_ATTACHMENT_LOAD_OP_CLEAR,
            .storeOp = VK_ATTACHMENT_STORE_OP_STORE,
            .clearValue =
        ...
        VkRenderingAttachmentInfo{
            .sType = VK_STRUCTURE_TYPE_RENDERING_ATTACHMENT_INFO,
            .imageView = *m.renderTargets.lights.specular,
            .imageLayout = VkImageLayout::VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL,
            .loadOp = VK_ATTACHMENT_LOAD_OP_CLEAR,
            .storeOp = VK_ATTACHMENT_STORE_OP_STORE,
            .clearValue =
  ...
  void Renderer::combinedLightBeginRendering(VkCommandBuffer cmdBuf) {
    VkRenderingAttachmentInfo colorAttachment{
        .sType = VK_STRUCTURE_TYPE_RENDERING_ATTACHMENT_INFO,
        .imageView = *m.renderTargets.lights.combined,
  ...
  void Renderer::colorImageToRenderable(VkCommandBuffer cmdBuf, const Image& image) {
    VkImageMemoryBarrier2 transition{
        .sType = VK_STRUCTURE_TYPE_IMAGE_MEMORY_BARRIER_2,
        .srcStageMask = VK_PIPELINE_STAGE_2_TOP_OF_PIPE_BIT,
        .srcAccessMask = 0,
  ...
  void Renderer::colorImageBeginRendering(VkCommandBuffer cmdBuf, const Image& image, bool clear) {
    VkRenderingAttachmentInfo colorAttachment{
        .sType = VK_STRUCTURE_TYPE_RENDERING_ATTACHMENT_INFO,
        .imageView = image,
        .imageLayout = VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL,
  ...
  void Renderer::colorImageToShaderRead(VkCommandBuffer cmdBuf, const Image& image) {
    VkImageMemoryBarrier2 transition{
        .sType = VK_STRUCTURE_TYPE_IMAGE_MEMORY_BARRIER_2,
        .srcStageMask = VK_PIPELINE_STAGE_2_COLOR_ATTACHMENT_OUTPUT_BIT,
