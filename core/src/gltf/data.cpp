...
namespace keptech::gltf {
  namespace {
    void loadMeshData(fastgltf::Asset& asset, Data& gltf) {
      ...
      std::for_each(
          std::execution::par, enumView.begin(), enumView.end(),
          [&](const std::tuple<size_t, fastgltf::Mesh&>& meshTuple) {
            ...
            for (auto& primitive : mesh.primitives) {
              Submesh submesh{
                  ...
                  .materialIndex = static_cast<uint32_t>(
                      primitive.materialIndex.value_or(0)),
              };
              ...
              if (primitive.materialIndex.has_value()) {
                ...
                if (material.pbrData.baseColorTexture.has_value()) {
                  ...
                  if (texInfo.transform &&
                    ...
                    baseColorTexIndex =
                        texInfo.transform->texCoordIndex.value();
                  }
                }
              }
