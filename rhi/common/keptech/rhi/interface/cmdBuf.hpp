...
CommandBuffer& copyBufferToImage(const rhi::BufferRef& buffer, const rhi::ImageRef& image, size_t width, size_t height, size_t mipLevel = 0,
                                 size_t bufferOffset = 0, size_t offsetX = 0, size_t offsetY = 0);
