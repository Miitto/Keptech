...
#define VK_TRACE(...) kt::rhi::logger->log(spdlog::source_loc{__FILE__, __LINE__, SPDLOG_FUNCTION}, spdlog::level::trace, __VA_ARGS__)
#else
#define VK_TRACE(...) (void)0
#endif

#if RENDERER_LOG_LEVEL <= SPDLOG_LEVEL_DEBUG
#define VK_DEBUG(...) kt::rhi::logger->log(spdlog::source_loc{__FILE__, __LINE__, SPDLOG_FUNCTION}, spdlog::level::debug, __VA_ARGS__)
#else
#define VK_DEBUG(...) (void)0
#endif

#if RENDERER_LOG_LEVEL <= SPDLOG_LEVEL_INFO
#define VK_INFO(...) kt::rhi::logger->log(spdlog::source_loc{__FILE__, __LINE__, SPDLOG_FUNCTION}, spdlog::level::info, __VA_ARGS__)
#else
#define VK_INFO(...) (void)0
#endif

#if RENDERER_LOG_LEVEL <= SPDLOG_LEVEL_WARN
#define VK_WARN(...) kt::rhi::logger->log(spdlog::source_loc{__FILE__, __LINE__, SPDLOG_FUNCTION}, spdlog::level::warn, __VA_ARGS__)
#else
#define VK_WARN(...) (void)0
#endif

#if RENDERER_LOG_LEVEL <= SPDLOG_LEVEL_ERROR
#define VK_ERROR(...) kt::rhi::logger->log(spdlog::source_loc{__FILE__, __LINE__, SPDLOG_FUNCTION}, spdlog::level::err, __VA_ARGS__)
#else
#define VK_ERROR(...) (void)0
#endif

#if RENDERER_LOG_LEVEL <= SPDLOG_LEVEL_CRITICAL
#define VK_CRITICAL(...) kt::rhi::logger->log(spdlog::source_loc{__FILE__, __LINE__, SPDLOG_FUNCTION}, spdlog::level::critical, __VA_ARGS__)
#else
