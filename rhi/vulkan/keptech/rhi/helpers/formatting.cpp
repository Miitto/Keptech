...
fmt::format_context::iterator fmt::formatter<kt::rhi::VkAccessFlags2Formatter>::format(kt::rhi::VkAccessFlags2Formatter formatter,
...
fmt::formatter<kt::rhi::VkPipelineStageFlags2Formatter>::format(kt::rhi::VkPipelineStageFlags2Formatter formatter,
                                                                fmt::format_context& ctx) const {
