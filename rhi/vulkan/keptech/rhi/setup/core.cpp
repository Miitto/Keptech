...
namespace kt::rhi {
  ...
  std::expected<void, std::string> RHI::initVulkanCore(const RendererCreateInfo& createInfo, const Window& window) {
  ...
  std::expected<void, std::string> RHI::initCommandPools(const std::set<uint32_t>& uniqueQueueFamilies) {
  ...
  std::expected<void, std::string> RHI::initSync() {
